...
mutual
  ...
  compileKeep (Alt re1 re2) with (SimplifyCode (CodeShapeREKeep re1)) proof p1
    compileKeep (Alt re1 re2) | sc1 with (SimplifyCode (CodeShapeREKeep re2)) proof p2
      ...
      compileKeep (Alt re1 re2) | CharC | UnitC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | CharC | IgnoreC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | (PairC x y) | UnitC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | (PairC x y) | IgnoreC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | StringC | UnitC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | StringC | IgnoreC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | UnitC | IgnoreC = (isJust . eitherToMaybe) `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | (EitherC x y) | UnitC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | (EitherC x y) | IgnoreC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | (MaybeC x) | UnitC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | (MaybeC x) | IgnoreC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | BoolC | UnitC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | BoolC | IgnoreC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | (ListC z) | UnitC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | (ListC z) | IgnoreC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | NatC | UnitC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
      ...
      compileKeep (Alt re1 re2) | NatC | IgnoreC = eitherToMaybe `map` altTyREKeep re1 re2 p1 p2
  ...
  compileKeep (Maybe re) with (SimplifyCode (CodeShapeREKeep re)) proof p
    compileKeep (Maybe re) | CharC = (rewrite p in eitherToMaybe) `map` compileKeep re <|> Untyped Empty
    compileKeep (Maybe re) | (PairC x y) = (rewrite p in eitherToMaybe) `map` compileKeep re <|> Untyped Empty
    compileKeep (Maybe re) | StringC = (rewrite p in eitherToMaybe) `map` compileKeep re <|> Untyped Empty
    compileKeep (Maybe re) | UnitC =
      let f : Either () () -> Bool
          f (Left _) = True
          f (Right _) = False
      in (rewrite p in f) `map` compileKeep re <|> Untyped Empty
    compileKeep (Maybe re) | (EitherC x y) = (rewrite p in eitherToMaybe) `map` compileKeep re <|> Untyped Empty
    compileKeep (Maybe re) | (MaybeC x) =
      let f : Either (Maybe (Sem x)) () -> (Maybe (Sem x))
          f (Left ms) = ms
          f (Right _) = Nothing
      in (rewrite p in f) `map` compileKeep re <|> Untyped Empty
    compileKeep (Maybe re) | BoolC = (rewrite p in eitherToMaybe) `map` compileKeep re <|> Untyped Empty
    compileKeep (Maybe re) | (ListC z) = (rewrite p in eitherToMaybe) `map` compileKeep re <|> Untyped Empty
    compileKeep (Maybe re) | NatC = (rewrite p in eitherToMaybe) `map` compileKeep re <|> Untyped Empty
...
mutual
  ...
  compile (Alt re1 re2) with (SimplifyCode (CodeShapeRE re1)) proof p1
    compile (Alt re1 re2) | sc1 with (SimplifyCode (CodeShapeRE re2)) proof p2
      ...
      compile (Alt re1 re2) | CharC | UnitC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | CharC | IgnoreC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | (PairC x y) | UnitC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | (PairC x y) | IgnoreC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | StringC | UnitC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | StringC | IgnoreC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | UnitC | IgnoreC = (isJust . eitherToMaybe) `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | (EitherC x y) | UnitC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | (EitherC x y) | IgnoreC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | (MaybeC x) | UnitC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | (MaybeC x) | IgnoreC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | BoolC | UnitC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | BoolC | IgnoreC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | (ListC z) | UnitC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | (ListC z) | IgnoreC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | NatC | UnitC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
      ...
      compile (Alt re1 re2) | NatC | IgnoreC = eitherToMaybe `map` altTyRE re1 re2 p1 p2
  ...
  compile (Maybe re) with (SimplifyCode (CodeShapeRE re)) proof p
    compile (Maybe re) | CharC = (rewrite p in eitherToMaybe) `map` compile re <|> Untyped Empty
    compile (Maybe re) | (PairC x y) = (rewrite p in eitherToMaybe) `map` compile re <|> Untyped Empty
    compile (Maybe re) | StringC = (rewrite p in eitherToMaybe) `map` compile re <|> Untyped Empty
    compile (Maybe re) | UnitC =
      let f : Either () () -> Bool
          f (Left _) = True
          f (Right _) = False
      in (rewrite p in f) `map` compile re <|> Untyped Empty
    compile (Maybe re) | (EitherC x y) = (rewrite p in eitherToMaybe) `map` compile re <|> Untyped Empty
    compile (Maybe re) | (MaybeC x) =
      let f : Either (Maybe (Sem x)) () -> (Maybe (Sem x))
          f (Left ms) = ms
          f (Right _) = Nothing
      in (rewrite p in f) `map` compile re <|> Untyped Empty
    compile (Maybe re) | BoolC = (rewrite p in eitherToMaybe) `map` compile re <|> Untyped Empty
    compile (Maybe re) | (ListC z) = (rewrite p in eitherToMaybe) `map` compile re <|> Untyped Empty
    compile (Maybe re) | NatC = (rewrite p in eitherToMaybe) `map` compile re <|> Untyped Empty
