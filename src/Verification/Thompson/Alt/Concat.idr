...
evidenceTh2 {re1, re2} (Step (CTh2 s) c (CTh2 t) prf1 acc) =
  let rest : EvidenceTh2Data {re1,re2} acc
      ...
      aos = aboutCombiningTransitionsForOld (twoToEndConcat (thompson re2) s c) (CTh2 t) prf1 t injectionForCTh2 Refl (ch2NotElemOFEnd _)
  in MkEvidenceTh2Data
...
evidenceTh1 {re1, re2} (Step (CTh1 s) c (CTh1 t) prf1 acc) =
  let sm1 : SM
      ...
      aos = aboutCombiningTransitionsForOld (oneToTwo sm1 sm2  s c) (CTh1 t) prf1 t injectionForCTh1 Refl (cTh1NotInStart2Cons (thompson re2) t)
...
evidenceTh1 (Step (CTh1 s) c (CTh2 t) prf1 acc) =
  let sm1 : SM
      ...
      aos = aboutCombiningTransitionsForOld (initTwoConcat sm2) (CTh2 t) ans.stateIsElemOfNew t injectionForCTh2 Refl (ch2NotElemOFEnd _)
  in MkEvidenceTh1Data
...
concatEvidencePrf {word=(c::w)} re1 re2 (Start (CTh2 s) prf (Step (CTh2 s) c t prf1 acc)) =
  let sm1 : SM
      ...
      aos = aboutCombiningTransitionsForOld (initTwoConcat sm2) (CTh2 s) ans.stateIsElemOfNew s injectionForCTh2 Refl (ch2NotElemOFEnd _)
...
concatEvidencePrf re1 re2 (Start (CTh1 s) prfInit (Step (CTh1 s) c t prf1 acc)) =
  let sm1 : SM
      ...
      aos = aboutCombiningTransitionsForOld (concatInit sm1 sm2) (CTh1 s) prfInit s injectionForCTh1 Refl (cTh1NotInStart2Cons sm2 s)
  in MkConcatEvidencePrfData
